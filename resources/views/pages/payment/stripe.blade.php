                ...
                <div class="contact_form_container">
                    ...
                    <form action="{{ route('stripe.charge') }}" method="post" id="payment-form" style="border: 1px solid grey; padding: 20px;">
                        ...
                        <div class="form-row">
                          ...
                          <!-- Extra Data -->
                          <input type="hidden" name="shipping" value="{{ $charge->shapping_charge }}">
                          <input type="hidden" name="vat" value="0">
                          @if(Session::has('coupon'))
                            <input type="hidden" name="total" value="{{ Session::get('coupon')['balance'] + $charge->shapping_charge }}">
                          @else
                            <input type="hidden" name="total" value="{{ Cart::Subtotal(2,'.','') + $charge->shapping_charge }}">
                          @endif
